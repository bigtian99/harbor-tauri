...
export const KLCJ_ZT_GIT_DEFAULTS: KlcjZtGitDefault[] = [
  ...
  {
    dir: "game-library---multiple-ads",
    keys: ["game-library---multiple-ads", "game-library", "multiple-ads"],
    git_url: `${GITEE}/game-library---multiple-ads.git`,
    role: "backend",
    expose_port: "9100",
  },
  {
    dir: "gameauxiliary",
    keys: ["gameauxiliary"],
    git_url: `${GITEE}/gameauxiliary.git`,
    role: "backend",
    expose_port: "9100",
  },
  {
    dir: "old-comic-backend-code",
    keys: ["old-comic-backend-code", "old-comic"],
    git_url: `${GITEE}/old-comic-backend-code`,
    role: "backend",
    expose_port: "9100",
  },
  {
    dir: "old-tv",
    keys: ["old-tv"],
    git_url: `${GITEE}/old-tv.git`,
    role: "backend",
    expose_port: "9100",
  },
  {
    dir: "packingmachine",
    keys: ["packingmachine", "packing-machine"],
    git_url: `${GITEE}/packingmachine.git`,
    role: "backend",
    expose_port: "9100",
  },
  {
    dir: "payment-for-fake-orders",
    keys: ["payment-for-fake-orders", "payment", "fake-orders"],
    git_url: `${GITEE}/payment-for-fake-orders.git`,
    role: "backend",
    expose_port: "9100",
  },
  {
    dir: "software-library",
    keys: ["software-library"],
    git_url: `${GITEE}/software-library.git`,
    role: "backend",
    expose_port: "9100",
  },
  {
    dir: "tksy-anime",
    keys: ["tksy-anime", "new-tv"],
    git_url: `${GITEE}/tksy-anime.git`,
    role: "backend",
    expose_port: "9100",
  },
  {
  ...
  },
  {
    dir: "tksy-component",
    keys: ["tksy-component"],
    git_url: `${GITEE}/tksy-component.git`,
    role: "backend",
    expose_port: "9100",
  },
  {
    dir: "video_java",
    keys: ["video_java", "video-java"],
    git_url: `${GITEE}/video_java.git`,
    role: "backend",
    expose_port: "9100",
  },
  {
